...
<body>
    <div class="container">
        ...
        <div class="co_bookmark">
            <h1>${cvo.cou_title}</h1>
            <button class="bookmarkBtn"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="white"  viewBox="0 0 16 16">
...
<!--     <script type="text/javascript" src="/resources/js/courselist.js">
    ...
    const conVal = '<c:out value="${svo.sub_num}" />';
    console.log("sub_num : " + conVal);
    getCourseContent(conVal);
    </script> -->
